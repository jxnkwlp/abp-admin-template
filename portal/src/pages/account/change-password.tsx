            ...
            >
                ...
                >
                    <ProFormText.Password
                        ...
                        label={intl.formatMessage({ id: 'page.profile.field.currentPassword' })}
                        width={'md'}
                    ...
                    <ProFormText.Password
                        rules={[{ required: true }, { max: 128 }]}
                        name="newPassword"
                        label={intl.formatMessage({ id: 'page.profile.field.newPassword' })}
                        width={'md'}
                        fieldProps={{ autoComplete: 'one-time-code' }}
                    />
                    <ProFormText.Password
                        ...
                        label={intl.formatMessage({ id: 'page.profile.field.confirmPassword' })}
                        width={'md'}
                        fieldProps={{ autoComplete: 'one-time-code' }}
                    />
                </ProForm>
