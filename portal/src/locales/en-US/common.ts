export default {
    ...
    'common.http.response.error.networkError2': 'An exception occurred in your network, unable to connect to the server',
    ...
    'common.http.response.statusCode.202': 'A request has been queued in the background (asynchronous task)',
    ...
    'common.http.response.statusCode.500': 'An error occurred on the server, please check the server',
